...
const ThirdStepDocs = ({ userId, onSuccess }) => {
  ...
  return (
    <div className={style.wrapper}>
      <h3>آپلود مدارک</h3>
      <p className={style.uploadDetail}>شما میتوانید با کلیک بر روی دکمه‌ی زیر مدارک مدنظر را آپلود کنید. (شناسنامه، بیمه ورزشی، فرم ثبت نام و ...)</p>
      {documents.length > 0 ? (
        ''
      ) : (
        <div className={style.endRegister}>
          <p>در صورتی که میخواهید مدارک را بعدا بارگزاری کنید بر روی لینک مقابل کلیک کنید.</p>
