...
from .views import AnnounceCreate, AnnounceList, MarkAnnouncementRead, AnnouncementsDelete, AnnounceUpdate
...
urlpatterns = [
    ...
    path('<int:id>/read/', MarkAnnouncementRead.as_view(), name='announcement-read'),
